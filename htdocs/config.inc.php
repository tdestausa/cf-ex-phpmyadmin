 ...
 * cookie
 */
$cfg['blowfish_secret'] = 'BlackPearlRocksThis1is2@3UniqueKey'; /* YOU MUST FILL IN THIS FOR COOKIE AUTH! */
...
foreach($service_blob as $service_provider => $service_list) {
    ...
    if ($service_provider === 'spba_qa' || $service_provider === 'spba_dev' || $service_provider === 'p-mysql') {
...
for ($i = 1; $i <= count($mysql_services); $i++) {
    ...
    /* Server parameters */
 //DEV   $cfg['Servers'][$i]['host'] = 'cg-aws-broker-prod-1563a3ac0048.ci7nkegdizyy.us-gov-west-1.rds.amazonaws.com';//$db['hostname'];
 //QA NOW  
    $cfg['Servers'][$i]['host'] = 'cg-aws-broker-prod-1563a3ac0048.ci7nkegdizyy.us-gov-west-1.rds.amazonaws.com';
//PROD    $cfg['Servers'][$i]['host'] = 'cg-aws-broker-prod-1563a3ac0048.ci7nkegdizyy.us-gov-west-1.rds.amazonaws.com';
    $cfg['Servers'][$i]['port'] = 3306;//$db['port'];
